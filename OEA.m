function [Best_Fitness,Best_Pos,Convergence_curve] = OEA(N,MaxFEs,lb,ub,dim,fobj)
    ...
    while FEs < MaxFEs
        ...
        for i = 1:N
            ...
            XPos_old = XPos(i,:);
            flagub=XPosNew(i,:)>ub;flaglb=XPosNew(i,:)<lb;
            XPosNew(i,flagub) = (XPos_old(flagub) + ub(flagub)) / 2;
            XPosNew(i,flaglb) = (XPos_old(flaglb) + lb(flaglb)) / 2;
